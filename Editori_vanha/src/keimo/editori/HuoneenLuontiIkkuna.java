...
public class HuoneenLuontiIkkuna {
    ...
    static void asetaArvot(int huoneenId, String huoneenNimi, int asetettuKentänKoko) {
        ...
        if (huoneKSH == null) {
            ...
            luoHuone(huoneenId, asetettuKentänKoko, huoneenNimi, null, "Oma alue", null, null, null, null, null, null);
        }
        else {
    ...
    private static void luoHuone(int huoneenId, int huoneenKoko, String huoneenNimi, String huoneenTaustanPolku, String huoneenAlue, ArrayList<KenttäKohde> huoneenKenttäSisältö, ArrayList<Maasto> huoneenMaastoSisältö, ArrayList<Entity> huoneenNPCSisältö, String musa, String alkuDialogi, String vaaditunTavoitteenTunniste) {
        ...
        HuoneEditoriIkkuna.huoneKartta.put(huoneenId, huone);
    }
