            ...
            case KOKO_TIEDOSTO:
                try {
                    ...
                    if (HuoneEditoriIkkuna.jfxAvattuTiedosto != null) {
                        ...
                        read.close();
                        HuoneEditoriIkkuna.crd.next(HuoneEditoriIkkuna.kortit);
                        HuoneEditoriIkkuna.tiedostoLadattu = true;
                    }
                }
                catch (IOException ioe) {
                    ioe.printStackTrace();
                    HuoneEditoriIkkuna.crd.last(HuoneEditoriIkkuna.kortit);
                }
        ...
        switch (tallennusTyyppi) {
            ...
            case VAIN_HUONE -> {
                try {
                    ...
                    if (tiedosto.isFile()) {
                        Writer fstream = new OutputStreamWriter(new FileOutputStream(tiedosto.getPath()), StandardCharsets.UTF_8);
                        HuoneEditoriIkkuna.jfxKokoTiedostoMerkkijonona = HuoneEditorinMetodit.luoMerkkijonoHuoneesta(HuoneEditoriIkkuna.huoneKartta, HuoneEditoriIkkuna.muokattavaHuone);
                        fstream.write(HuoneEditoriIkkuna.jfxKokoTiedostoMerkkijonona);
                        fstream.close();
                    }
                    else {
