package keimo.editori.muokkausIkkunat;
...
public class SpawnpointMuokkaus {
    ...
    private static void hyväksyMuutokset(int sijX, int sijY) {
        try {
            ...
            else if (x >= HuoneEditoriIkkuna.huoneKartta.get(0).annaKoko() || y >= HuoneEditoriIkkuna.huoneKartta.get(0).annaKoko()) {
    ...
    public static void luoSpawnpointMuokkausIkkuna() {
        ...
        if (!HuoneEditoriIkkuna.tiedostoLadattu) {
            JOptionPane.showMessageDialog(muokkausIkkuna, "Avaa kst-tiedosto ensin.", "Ei valittua tiedostoa", JOptionPane.INFORMATION_MESSAGE);
        }
        else {
