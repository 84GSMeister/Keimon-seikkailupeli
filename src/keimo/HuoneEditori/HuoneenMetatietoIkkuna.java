...
public class HuoneenMetatietoIkkuna {
    ...
    static final int ikkunanLeveys = 450;
    ...
    public static void luoIkkuna() {
        ...
        huoneenDialogiTekstiKenttäLabel.setToolTipText("TODO: Lisää valikko");
        huoneenDialogiValintaTekstiKenttä = new JTextField();
        huoneenTavoiteTekstiKenttäLabel = new JLabel("Huoneen tavoite: ");
        huoneenTavoiteTekstiKenttäLabel.setToolTipText("TODO: Lisää valikko");
        ...
        placeholder5.setFont(new Font("Arial", Font.PLAIN, 18));
        ...
        yläVasenPaneeli.add(huoneenTavoiteTekstiKenttä);
        ...
        okNappi.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (huoneenNimiTekstiKenttä.getText().contains("(") || huoneenNimiTekstiKenttä.getText().contains(")")) {
                    ...
                    HuoneEditoriIkkuna.huoneenAlkuDialoginTunniste = huoneenDialogiValintaTekstiKenttä.getText();
