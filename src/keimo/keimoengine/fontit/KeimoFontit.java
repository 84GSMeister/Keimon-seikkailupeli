...
public class KeimoFontit {
    ...
    fontti_keimo_30,
    fontti_keimo_36,
    fontti_keimo_100; // Vältä tätä: 100-koon fontin renderöinti lagittaa aika paljon
    
    private static boolean openFontTTF(String name) {
        ...
        try {
            ...
            fontti_keimo_100 = fontti.deriveFont(100f);
            return true;
        }
        catch (Exception e) {
    ...
    public static void rekisteröiFontit() {
        if (openFontTTF("keimon_paskafontti")) {
            ...
            ge.registerFont(fontti_keimo_100);
        }
    }
}
