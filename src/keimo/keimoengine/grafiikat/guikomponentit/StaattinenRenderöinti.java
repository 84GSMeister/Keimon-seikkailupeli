...
/**
 * Staattisia funktioita varten. Jos halutaan käyttää samaa renderöintifunktiota useita kertoja, mutta ei haluta
 * luoda objekteja jokaiselle instanssille.
 */

public class StaattinenRenderöinti {
