...
public class VirheRuutu {
    private static Teksti otsikkoTeksti = new Teksti("Paskan möivät", Väri.white, 2000, 300, KeimoFontit.fontti_keimo_100, true);
    private static Teksti tekstiTexture = new Teksti("Virheteksti", Väri.white, 3000, 900);
    private static Teksti näppäimetTexture = new Teksti("F1: Käynnistä uudelleen    Esc: sulje", Väri.white, 4200, 300, KeimoFontit.fontti_keimo_100, false);
