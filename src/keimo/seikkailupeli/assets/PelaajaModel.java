...
public class PelaajaModel {
    ...
    private Renderöitävä hyökkäysTekstuuri = Assets.annaTekstuuri("hyökkäys_sprite");
    private Renderöitävä esineTekstuuri = Assets.annaTekstuuri("vakio");
    private Renderöitävä hitboxKehysTekstuuri = Assets.annaTekstuuri("entity_hitbox_kehys");
    ...
    public PelaajaModel() {
        ...
        this.animaatiot.put("default", new Animaatio("tiedostot/kuvat/pelaaja/default.gif"));
        this.animaatiot.put("ylensyönti", new Animaatio("tiedostot/kuvat/pelaaja/ylensyönti.gif"));
        this.animaatiot.put("kuollut", new Animaatio("tiedostot/kuvat/pelaaja/kuollut.gif"));

        this.animaatiot.put("idle_hyvä_laiha", new Animaatio("tiedostot/kuvat/pelaaja/idle/idle_hyvä_laiha.gif"));
        this.animaatiot.put("idle_hyvä_normaali", new Animaatio("tiedostot/kuvat/pelaaja/idle/idle_hyvä_normaali.gif"));
        this.animaatiot.put("idle_hyvä_lihava", new Animaatio("tiedostot/kuvat/pelaaja/idle/idle_hyvä_lihava.gif"));
        this.animaatiot.put("idle_hyvä_erittäinlihava", new Animaatio("tiedostot/kuvat/pelaaja/idle/idle_hyvä_erittäinlihava.gif"));
        this.animaatiot.put("idle_neutraali_laiha", new Animaatio("tiedostot/kuvat/pelaaja/idle/idle_neutraali_laiha.gif"));
        this.animaatiot.put("idle_neutraali_normaali", new Animaatio("tiedostot/kuvat/pelaaja/idle/idle_neutraali_normaali.gif"));
        this.animaatiot.put("idle_neutraali_lihava", new Animaatio("tiedostot/kuvat/pelaaja/idle/idle_neutraali_lihava.gif"));
        this.animaatiot.put("idle_neutraali_erittäinlihava", new Animaatio("tiedostot/kuvat/pelaaja/idle/idle_neutraali_erittäinlihava.gif"));
        this.animaatiot.put("idle_huono_laiha", new Animaatio("tiedostot/kuvat/pelaaja/idle/idle_huono_laiha.gif"));
        this.animaatiot.put("idle_huono_normaali", new Animaatio("tiedostot/kuvat/pelaaja/idle/idle_huono_normaali.gif"));
        this.animaatiot.put("idle_huono_lihava", new Animaatio("tiedostot/kuvat/pelaaja/idle/idle_huono_lihava.gif"));
        this.animaatiot.put("idle_huono_erittäinlihava", new Animaatio("tiedostot/kuvat/pelaaja/idle/idle_huono_erittäinlihava.gif"));
        
        this.animaatiot.put("kävely_sivulle_laiha", new Animaatio("tiedostot/kuvat/pelaaja/kävely/kävely_sivulle_laiha.gif"));
        this.animaatiot.put("kävely_ylös_laiha", new Animaatio("tiedostot/kuvat/pelaaja/kävely/kävely_ylös_laiha.gif"));
        this.animaatiot.put("kävely_alas_laiha", new Animaatio("tiedostot/kuvat/pelaaja/kävely/kävely_alas_laiha.gif"));
        this.animaatiot.put("kävely_yläsivu_laiha", new Animaatio("tiedostot/kuvat/pelaaja/kävely/kävely_yläsivu_laiha.gif"));
        this.animaatiot.put("kävely_alasivu_laiha", new Animaatio("tiedostot/kuvat/pelaaja/kävely/kävely_alasivu_laiha.gif"));
        this.animaatiot.put("kävely_sivulle_normaali", new Animaatio("tiedostot/kuvat/pelaaja/kävely/kävely_sivulle_normaali.gif"));
        this.animaatiot.put("kävely_ylös_normaali", new Animaatio("tiedostot/kuvat/pelaaja/kävely/kävely_ylös_normaali.gif"));
        this.animaatiot.put("kävely_alas_normaali", new Animaatio("tiedostot/kuvat/pelaaja/kävely/kävely_alas_normaali.gif"));
        this.animaatiot.put("kävely_yläsivu_normaali", new Animaatio("tiedostot/kuvat/pelaaja/kävely/kävely_yläsivu_normaali.gif"));
        this.animaatiot.put("kävely_alasivu_normaali", new Animaatio("tiedostot/kuvat/pelaaja/kävely/kävely_alasivu_normaali.gif"));
        this.animaatiot.put("kävely_sivulle_lihava", new Animaatio("tiedostot/kuvat/pelaaja/kävely/kävely_sivulle_lihava.gif"));
        this.animaatiot.put("kävely_ylös_lihava", new Animaatio("tiedostot/kuvat/pelaaja/kävely/kävely_ylös_lihava.gif"));
        this.animaatiot.put("kävely_alas_lihava", new Animaatio("tiedostot/kuvat/pelaaja/kävely/kävely_alas_lihava.gif"));
        this.animaatiot.put("kävely_yläsivu_lihava", new Animaatio("tiedostot/kuvat/pelaaja/kävely/kävely_yläsivu_lihava.gif"));
        this.animaatiot.put("kävely_alasivu_lihava", new Animaatio("tiedostot/kuvat/pelaaja/kävely/kävely_alasivu_lihava.gif"));
        this.animaatiot.put("kävely_sivulle_erittäinlihava", new Animaatio("tiedostot/kuvat/pelaaja/kävely/kävely_sivulle_erittäinlihava.gif"));
        this.animaatiot.put("kävely_ylös_erittäinlihava", new Animaatio("tiedostot/kuvat/pelaaja/kävely/kävely_ylös_erittäinlihava.gif"));
        this.animaatiot.put("kävely_alas_erittäinlihava", new Animaatio("tiedostot/kuvat/pelaaja/kävely/kävely_alas_erittäinlihava.gif"));
        this.animaatiot.put("kävely_yläsivu_erittäinlihava", new Animaatio("tiedostot/kuvat/pelaaja/kävely/kävely_yläsivu_erittäinlihava.gif"));
        this.animaatiot.put("kävely_alasivu_erittäinlihava", new Animaatio("tiedostot/kuvat/pelaaja/kävely/kävely_alasivu_erittäinlihava.gif"));
    ...
    public void render(Kamera camera, Ikkuna window) {
        ...
        if (Pelaaja.hyökkäysAika > 0) {
            ...
            hyökkäysTekstuuri = Assets.annaTekstuuri("hyökkäys_sprite");
        ...
        if (PelinAsetukset.debugTiedot) {
            renderöiHitboxKehys(Pelaaja.hitbox, camera);
        }
    ...
    public void renderöiHitboxKehys(Neliö hitbox, Kamera camera) {
        pelaajaShaderStaattinen.bind();
        pelaajaShaderStaattinen.asetaSijainti(transform.getProjection(camera.getProjection()));
        hitboxKehysTekstuuri = Assets.annaTekstuuri("entity_hitbox_kehys");
