...
public class KehittäjäRuutu {
    ...
    private static Teksti tieto1Teksti = new Teksti("Tuottaja: ", Color.white, 2000, 125, KeimoFontit.fontti_keimo_100, false);
    private static Teksti tieto2Teksti = new Teksti("Pelisuunnittelu: ", Color.white, 2000, 125, KeimoFontit.fontti_keimo_100, false);
    private static Teksti tieto3Teksti = new Teksti("Ohjelmointi: ", Color.white, 2000, 125, KeimoFontit.fontti_keimo_100, false);
    private static Teksti tieto4Teksti = new Teksti("Grafiikat: ", Color.white, 2000, 125, KeimoFontit.fontti_keimo_100, false);
    private static Teksti tieto5Teksti = new Teksti("Animaatiot: ", Color.white, 2000, 125, KeimoFontit.fontti_keimo_100, false);
    private static Teksti tieto6Teksti = new Teksti("3D-mallinnus: ", Color.white, 2000, 125, KeimoFontit.fontti_keimo_100, false);
    private static Teksti tieto7Teksti = new Teksti("Äänisuunnittelu: ", Color.white, 2000, 125, KeimoFontit.fontti_keimo_100, false);
    private static Teksti tieto8Teksti = new Teksti("Musat: ", Color.white, 2000, 125, KeimoFontit.fontti_keimo_100, false);
    private static Teksti tieto9Teksti = new Teksti("Kenttäsuunnittelu: ", Color.white, 2000, 125, KeimoFontit.fontti_keimo_100, false);
    private static Teksti tieto10Teksti = new Teksti("Tarina: ", Color.white, 2000, 125, KeimoFontit.fontti_keimo_100, false);

    private static Teksti kehittäjä1Teksti = new Teksti("Joonatan", Color.white, 1600, 125, KeimoFontit.fontti_keimo_100, false);
    private static Teksti kehittäjä2Teksti = new Teksti("Joonatan", Color.white, 1600, 125, KeimoFontit.fontti_keimo_100, false);
    private static Teksti kehittäjä3Teksti = new Teksti("Joonatan", Color.white, 1600, 125, KeimoFontit.fontti_keimo_100, false);
    private static Teksti kehittäjä4Teksti = new Teksti("Unto", Color.white, 1600, 125, KeimoFontit.fontti_keimo_100, false);
    private static Teksti kehittäjä5Teksti = new Teksti("Unto", Color.white, 1600, 125, KeimoFontit.fontti_keimo_100, false);
    private static Teksti kehittäjä6Teksti = new Teksti("Joonatan", Color.white, 1600, 125, KeimoFontit.fontti_keimo_100, false);
    private static Teksti kehittäjä7Teksti = new Teksti("Joonatan", Color.white, 1600, 125, KeimoFontit.fontti_keimo_100, false);
    private static Teksti kehittäjä8Teksti = new Teksti("Joonatan", Color.white, 1600, 125, KeimoFontit.fontti_keimo_100, false);
    private static Teksti kehittäjä9Teksti = new Teksti("Kristian", Color.white, 1600, 125, KeimoFontit.fontti_keimo_100, false);
    private static Teksti kehittäjä10Teksti = new Teksti("Kristian", Color.white, 1600, 125, KeimoFontit.fontti_keimo_100, false);
