...
public class ÄäniTestiRuutu {
    ...
    private static Teksti asetusWoofTeksti = new Teksti("Woof", Color.white, 600, 48);
    ...
    private static Teksti tilaNuottiTeksti = new Teksti("50", Color.white, 800, 48);
    private static Teksti tilaWoofTeksti = new Teksti("Ei", Color.white, 800, 48);
    ...
    public static void render(Window window) {
        ...
        infoTeksti.päivitäTeksti(infoTekstiString, 0, 58);
        infoTeksti.bind(0);
        Assets.getModel().render();
    }
