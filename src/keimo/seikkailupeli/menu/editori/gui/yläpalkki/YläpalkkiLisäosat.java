...
public class YläpalkkiLisäosat {
    ...
    private static Nappi dialogiEditoriNappi = new Nappi(0.05f, 0.05f, -0.3f, 0.8f, Assets.annaTekstuuri("editori_lisäosat_dialogieditori"), new TooltipTeksti("Tulossa myöhemmin!", 640, 48));
    private static Nappi tarinaEditoriNappi = new Nappi(0.05f, 0.05f, -0.2f, 0.8f, Assets.annaTekstuuri("editori_lisäosat_tarinaeditori"), new TooltipTeksti("Tulossa myöhemmin!", 640, 48));
    ...
    protected static void alustaGrafiikat() {
        otsikkoTeksti = new Teksti("Lisäosat", Color.white, 400, 48);
