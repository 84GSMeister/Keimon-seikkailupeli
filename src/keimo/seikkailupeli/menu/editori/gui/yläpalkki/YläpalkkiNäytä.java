...
public class YläpalkkiNäytä {
    ...
    private static StaattinenKomponentti näytäMaastoLabel = new StaattinenKomponentti(0.025f, 0.03f, -0.25f, 0.86f, Assets.annaTekstuuri("editori_näytä_maasto"));
    ...
    private static StaattinenKomponentti näytäObjektitLabel = new StaattinenKomponentti(0.025f, 0.03f, -0.25f, 0.8f, Assets.annaTekstuuri("editori_näytä_objektit"));
