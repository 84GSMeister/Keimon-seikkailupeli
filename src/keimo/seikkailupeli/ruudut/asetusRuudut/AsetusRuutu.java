...
import keimo.seikkailupeli.ruudut.asetusRuudut.grafiikkatestiRuudut.GrafiikkaTestiMatriisit;
import keimo.seikkailupeli.ruudut.asetusRuudut.grafiikkatestiRuudut.GrafiikkaTestiShaderit;
import keimo.seikkailupeli.ruudut.asetusRuudut.grafiikkatestiRuudut.GrafiikkaTestiTekstuurit;
import keimo.seikkailupeli.ruudut.asetusRuudut.grafiikkatestiRuudut.GrafiikkaTestiValikko;
import keimo.seikkailupeli.ruudut.asetusRuudut.äänitestiRuudut.ÄäniTestiMidi;
import keimo.seikkailupeli.ruudut.asetusRuudut.äänitestiRuudut.ÄäniTestiRuutu;
import keimo.seikkailupeli.ruudut.asetusRuudut.äänitestiRuudut.ÄäniTestiValikko;
    ...
    public static void alustaGrafiikat() {
        if (!grafiikatAlustettu) {
            asetusTekstit = new Renderöitävä[] {
                new Teksti("Grafiikka", Väri.white, 400, 48),
                new Teksti("Ääni", Väri.white, 400, 48),
                new Teksti("Peli", Väri.white,400, 48),
                new Teksti("Ohjaimet", Väri.white,400, 48),
                hyväksyTekstuuri,
            };
        ...
        switch (aktiivinenAsetusRuutu) {
            case ASETUSRUUTU -> {
                ...
                for (int i = 0; i < asetustenMäärä; i++) {
                    ...
                    StaattinenRenderöinti.renderöiKomponenttiJaSkaalaa(shader, asetusTekstit[i], window, 1f/2f, 1f/15f, 1, 0, offsetY, 0);
                }
            }
            case GRAFIIKKA -> {
