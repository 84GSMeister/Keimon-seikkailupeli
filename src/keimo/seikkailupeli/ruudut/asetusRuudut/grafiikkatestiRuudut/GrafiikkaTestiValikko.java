...
public class GrafiikkaTestiValikko {
    ...
    private static Teksti asetus1Teksti = new Teksti("Tekstuuritesti", Väri.white, 600, 48);
    private static Teksti asetus2Teksti = new Teksti("Shader-testi", Väri.white, 600, 48);
    private static Teksti asetus3Teksti = new Teksti("Matriisitesti", Väri.white, 600, 48);
    ...
    public static void render(Shader shader, Ikkuna window) {
        ...
        for (int i = 0; i < asetustenMäärä; i++) {
            ...
            StaattinenRenderöinti.renderöiKomponenttiJaSkaalaa(shader, annaAsetusTekstuuri(i), window, 1f/2f, 1f/15f, 1, 0, offsetY, 0);
        }
    }
