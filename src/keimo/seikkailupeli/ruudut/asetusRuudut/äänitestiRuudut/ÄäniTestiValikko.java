...
public class ÄäniTestiValikko {
    ...
    private static Teksti asetus1Teksti = new Teksti("Peliäänitesti", Väri.white, 600, 48);
    private static Teksti asetus2Teksti = new Teksti("Miditesti", Väri.white, 600, 48);
    private static Teksti asetus3Teksti = new Teksti("Wooftesti", Väri.white,600, 48);
